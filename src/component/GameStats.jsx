...
export default function GameStats(props) {
  ...
  const bestMinutes = ("0" + Math.floor((props.bestTime / 60000) % 60)).slice(
    -2
  );
  const bestSeconds = ("0" + Math.floor((props.bestTime / 1000) % 60)).slice(
    -2
  );
  ...
  return (
    <ul className="game-stats">
      <li>
        <p>
          <i className="fa-solid fa-dice"></i> Dice rolls:
        </p>
        <span>{props.rolls}</span>
      </li>
      <li>
        <p>
          <i className="fa-solid fa-clock"></i> Time elapsed:
        </p>
        <span>
      ...
      <li>
        <p>
          <i className="fa-solid fa-dice"></i> Best Rolls:
        </p>
      ...
      <li>
        ...
        <span>
          {bestMinutes}:{bestSeconds}:{bestMilliseconds}
        </span>
      </li>
    </ul>
  );
